// ============================================================
// Morpho GraphQL Client — Single Source of Truth
// ============================================================

import type { MorphoMarket, MorphoVault } from "./types";
import { CHAIN_NAMES, ALL_MORPHO_CHAIN_IDS } from "./chains";

export const MORPHO_API = process.env.MORPHO_API_URL || "https://api.morpho.org/graphql";
...
export async function fetchVaults(
  chains: number[] = [...ALL_MORPHO_CHAIN_IDS],
  topN: number = 200
): Promise<MorphoVault[]> {
